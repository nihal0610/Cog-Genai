...
if uploaded_file is not None and openai_api_key:
        ...
        with st.sidebar:
           ...
           input = f"Read each and every row from the datasheet provided and extract the Project ID's in a list, whose days_{d} from {b} is {e} {c} and project type is {a}. Please dont deviate from the instruction."
